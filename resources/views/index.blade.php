                ...
                <div class="container">
                    <div class="row">
                        ...
                        <a class="mouse-scroll" href="#about">
                            ...
                            <span class="mouse-message fadeIn">Esplora</span> <br />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="main_about text-center">
                                <h1 class="text-black">Hungry for Tech</h1>
                                <h2 class="text-white">- & -</h2>
                                <h3 class="text-black text-uppercase">We love to design new ways of audiovisivo</h3>
